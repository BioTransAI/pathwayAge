...
def loadingData():
    ...
    GO = pd.read_csv("./Result/AgeAccPerGOFemale.csv", index_col = 0)
    # alternatively Male 
    # GO = pd.read_csv("./Result/AgeAccPerGOMale.csv", index_col = 0)
    GO = GO.drop(columns = ["Tag", "Cohort"]).astype(float).join(GO[["Tag", "Cohort"]])
    KEGG = pd.read_csv("./Result/AgeAccPerKEGGFemale.csv", index_col = 0)
    # alternatively Male 
    # KEGG = pd.read_csv("./Result/AgeAccPerKEGGMale.csv", index_col = 0)
